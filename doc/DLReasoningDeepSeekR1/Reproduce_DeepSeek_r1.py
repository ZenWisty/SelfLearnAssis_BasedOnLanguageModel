...
def chinese_data(data):
    data = load_dataset("swulling/gsm8k_chinese")
...
if __name__ == '__main__':
    ...
    data = english_data(split="train")
    
    output_dir="E:\Python_work\LLM_MetaGPT\Publish\SelfLearnAssis_BasedOnLanguageModel\doc\DLReasoningDeepSeekR1\output"
